    ...
    return (
        <div className="container mx-auto px-6 py-12 sm:py-24 lg:px-12">
            ...
            <div className="mt-16 grid gap-12 lg:grid-cols-2 max-w-6xl mx-auto">
                ...
                >
                    {[
                        { icon: Mail, title: "Email", value: "betelhem453@gmail.com", color: "text-emerald-600 dark:text-primary" },
                        { icon: MapPin, title: "Location", value: "Debre Berhan, Ethiopia", color: "text-teal-600 dark:text-secondary" },
                        { icon: Phone, title: "Telegram", value: "@Betel1221", color: "text-emerald-500" }
                    ].map((info, i) => (
                        <div key={i} className="group flex gap-6 p-8 rounded-[2rem] border border-slate-200 dark:border-white/10 bg-white dark:bg-white/5 transition-all hover:bg-emerald-50 dark:hover:bg-white/10 shadow-md">
                            ...
                            <div>
                                <h3 className="text-sm font-bold uppercase tracking-widest text-slate-500">{info.title}</h3>
                ...
                >
                    ...
                    <button
                        type="submit"
                        className="group relative w-full overflow-hidden rounded-2xl bg-primary py-5 font-black uppercase tracking-[0.2em] text-white transition-all hover:scale-[1.02] active:scale-95 shadow-2xl shadow-primary/20"
                    >
                    ...
                    {status && (
                        <motion.p
                            ...
                            className="text-center text-emerald-600 dark:text-accent font-bold"
                        >
                            {status}
                        </motion.p>
                    )}
